...
export default function Nav() {
  return (
    <div className="fixed left-0 right-0 top-8 z-10 py-8 drop-shadow-sm">
      <div className="centered-block relative flex flex-wrap items-center justify-between">
        ...
        <ul className="relative z-20 hidden flex-wrap justify-between py-3 font-inter tracking-wide text-raisin-black duration-300 group-[.scrolling]:opacity-0 lg:flex">
          <Links
            liClassName="px-4"
